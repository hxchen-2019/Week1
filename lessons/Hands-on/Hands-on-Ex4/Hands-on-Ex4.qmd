...
::: callout-note
Usually Adaptive KDE using the jitter method will result in a more pixelated map.

It might be preferred to use a fixed method if all the points are far apart. Jitter is preferred if the points are clustered together.
:::
...
::: callout-note
L function is preferred as it is easier to understand than 0
:::
