...
We need to convert these data values into character data type/
...
Check if there are duplicate data or not.
...
If duplcated records are found, the code chunk below will be used to retain.
